...
using ASPCommerce.Helpers; // Import the namespace where PasswordHelper is defined
    ...
    public class UserController : ControllerBase
    {
        ...
        private int UpdateUserInformation(MySqlConnection connection, int userId, UserUpdateModel userModel)
        {
            ...
            using (var updateCommand = new MySqlCommand(updateQuery, connection))
            {
                ...
                updateCommand.Parameters.AddWithValue("@IsEmailVerified", userModel.IsEmailVerified ?? false);
        ...
        public IActionResult VerifyEmail(string email, string code)
        {
            try
            {
                using (MySqlConnection connection = new MySqlConnection(_connectionString))
                {
                    ...
                    using (MySqlCommand verifyCommand = new(verifyQuery, connection))
                    {
